...
<button type='button' value="otp_" className='btn btn-success fw-bold mx-5' onClick={this.wallet_connect } style={{width:"120px",fontSize:'25px'}}>Connect Wallet</button>
